(function (root, factory) {
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = factory(
            ...
            require('./history.js'),
            require('./setup/terrain-placement.js'),
            require('./setup/army-builder.js'),
            require('./persistence.js'),
            require('./setup/game-settings.js'),
            require('./board/input.js'),
            require('./board/interaction.js'),
            require('./board/render.js'),
            require('./game-flow.js'),
            require('./reserve.js'),
            require('./setup/camera.js'),
