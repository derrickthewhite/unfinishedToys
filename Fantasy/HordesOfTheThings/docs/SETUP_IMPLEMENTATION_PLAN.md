...
```powershell
node --test test/**/*.test.js tools/**/*.test.js
```

The focused application suite includes deployment snapping, Auto Deploy, Shift/marquee selection, return-to-tray, tray drag-and-drop, pointer-release handling, setup-camera pan/zoom, and setup save/load resumption. The full `node --test test/**/*.test.js tools/**/*.test.js` suite has 132 passing tests.
...
- Run `node --test test/**/*.test.js tools/**/*.test.js` after the slice
...
- Run `node --test test/**/*.test.js tools/**/*.test.js` after each completed slice.
