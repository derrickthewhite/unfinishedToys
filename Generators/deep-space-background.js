/*
 * Deep Space Battlefield Background Generator
 *
 * Standalone tool library for Generators/DeepSpaceBattlefieldGenerator.html.
 * Space4x has its own fork under SciFi/Space4x/js/lib/ — keep them separate.
 *
